...
/**
 * Item in *CaseStudies → Default → Primary → Display*
 */
export interface CaseStudiesSliceDefaultPrimaryDisplayItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → Display*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.display[].case_study
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * Display field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.display[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  display: prismic.GroupField<
    Simplify<CaseStudiesSliceDefaultPrimaryDisplayItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      BentoSliceDefault,
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryDisplayItem,
